...
public class SmallBoard {
	...
	/**
	 * The starting position of the board (Mainly for use on a BigBoard)
	 */
	private int startPosition = 0;
	/**
	 * The most recent move made in a game
	 */
	private int mostRecentMove;
	/**
	 * A 3x3 tic tac toe gameboard
	 */
	public SmallBoard() {	
	}
	/**
	 * A 3x3 tic tac toe gameboard starting at a desired spot
	 * @param startPos - Position to be started between 1-9
	 */
	public SmallBoard(int startPos) {
		this.setPosition(startPos);
	}
	/**
	 * A 3x3 board made with moves predetermined
	 * @param b - The predetermined moves to set the board
	 */
